    ...
    <div className="space-y-5">
      ...
      <section className="rounded-[22px] border border-amber-300/25 bg-amber-300/[0.08] p-4">
        ...
        <p className="mt-2 text-sm leading-6 text-amber-50/90">
          Это не рекомендация и не гарантия доходности. Список основан на моём
          рабочем отборе и опыте: я выбрал инструменты, которые считаю более
          надёжными для новичка. Возможно, в других местах APY выше, но там
          может быть больше риск, сложность или хуже выход из позиции. Перед
          действием проверяйте актуальные условия, комиссии сети и сроки вывода.
        </p>
